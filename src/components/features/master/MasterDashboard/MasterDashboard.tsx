  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen">
      <header className="mb-10">
        ...
        <p className="text-lg text-gray-600">Ваша панель управління RepairHub</p>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Статистика по Замовленням</h2>
          <MasterChart />
        </div>
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Стрічка Активності</h2>
          <OrderFeed />
        </div>
      </div>
    </div>
