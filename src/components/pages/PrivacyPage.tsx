          ...
          <section className="space-y-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              {t('privacy.introduction.text') || 
                'RepairHub Pro (далі — "Платформа", "ми", "наш") поважає вашу конфіденційність і зобов\'язується захищати ваші персональні дані. Ця Політика конфіденційності описує, як ми збираємо, використовуємо, зберігаємо та захищаємо інформацію користувачів нашої платформи для пошуку майстрів та замовлення ремонту техніки.'}
            </p>
          </section>
